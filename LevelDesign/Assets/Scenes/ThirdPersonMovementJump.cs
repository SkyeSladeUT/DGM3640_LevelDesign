...
public class ThirdPersonMovementJump : MonoBehaviour
{
    ...
    {
        _moveVec = Vector3.zero;
        _moveVec = Camera.right * Input.GetAxis("Horizontal") * SideSpeed 
                   + Camera.forward * Input.GetAxis("Vertical") * ForwardSpeed;
